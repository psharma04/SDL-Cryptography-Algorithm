#Import core libraries: math, os, binascii, webbrowser, time, getpass from getpass, randint and seed from random
import math
import os
import sys
import binascii
...
time.sleep(1)
prGreen(randint(0,))
#Simple script to list all files two dircetories up
